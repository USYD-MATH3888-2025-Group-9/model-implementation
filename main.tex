...
%		\vspace{0.1cm}
		...
		The paper demonstrates experimentally (via computational simulation) the existence of spiral waves in both the examples provided.\\
		The wavetrains were identified with the use of AUTO in the paper, this is possible for us, although python alternatives such as PyCoBi\footfullcite{PyCoBiPackage} and scFates \footfullcite{scFatesPaper} \footfullcite{scFatesGithub} are also of interest.
...
\end{document}Wavetrains \& Spiral Waves2Model Equations
