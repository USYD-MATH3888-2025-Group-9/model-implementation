...
\begin{document}
	...
	\begin{frame}
	\centering
	\frametitle{Inhibitor-Induced Wavetrains and Spiral Waves in an Extended FitzHugh--Nagumo Model}
	\maketitle
	
	\begin{center}
		\includegraphics[width=0.45\linewidth]{Screenshot 2025-09-03 145506.png}
	...
	\begin{frame}
		...
		f(v)=v(1-v)(v-\alpha)
		\]
		for typical values within \(0<\alpha<1,\varepsilon\ll 1,\gamma\approx0.5\) \cite{GaniM.Osman2022IWaS}\cite{LabouriauIsabelSalgado2014Psia}. This simplifies the four Hodgkin-Huxley equations to two: one fast and one slow. The circuit diagram below has equivalent function \cite{mathpys}.
		\begin{center}
			\begin{circuitikz}
