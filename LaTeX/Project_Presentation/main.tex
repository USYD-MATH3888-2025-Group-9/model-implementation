...
\begin{document}
	...
	\begin{frame}
		...
		f(v)=v(1-v)(v-\alpha)
		\]
		for typical values within \(0<\alpha<1,\varepsilon\ll 1,\gamma\approx0.5\) \cite{GaniM.Osman2022IWaS}. This simplifies the four Hodgkin-Huxley equations to two: one fast and one slow. The circuit diagram below has equivalent function \cite{Textbook}.
		\begin{center}
			\begin{circuitikz}
