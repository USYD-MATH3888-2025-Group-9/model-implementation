...
def main():
    ...
    ###########################
    params = Parameters()
    V0 = [-40,0.95,0.1,0.6,0.05,0.9,0.4]
    t_scaling = 10000
    t_span = [0, max_t*t_scaling]
    ...
    tspace = np.linspace(0,max_t,numvals)
    ...
    ax2_1.plot(tspace, [Parameters.I(Parameters, i) for i in tspace],label = "Current")
    ax2_1.plot(tspace, [v_shift(i,3) for i in tspace], label = "Voltage")
    ax2_1.legend()
    ax2_1.set_title("Stimulating current,voltage from model")
    ...
    ax4_1.set_title("Stimulating currentfrom data")
    ...
    ax1_2.plot(tspace[740000:760000],V_VALS[740000:760000], label = "Data values")
    ...
    ax2_2.plot(tspace[740000:760000], I_VALS[740000:760000])
