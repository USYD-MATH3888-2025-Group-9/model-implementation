...
- Calvin:
    - Writing 3 .ode files for the different timescales, to be run in XPPAUT
- Tim:
    - Getting a handle on the physionet database, this will allow us to check our results
